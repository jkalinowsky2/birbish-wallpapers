...
export function OrdersClosedAnnouncement() {
  const [open, setOpen] = useState(true); // Always true on mount
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <p className="mb-4 text-sm text-gray-600">
          The shop is temporarily unavailable while new stock is prepared. More stickers coming soon...feel free to look around!
        </p>
...
// const STORAGE_KEY_CLOSED = "genmerch_orders_closed_announcement_dismissed";
...
//     const dismissed = window.localStorage.getItem(STORAGE_KEY_CLOSED);
...
//       window.localStorage.setItem(STORAGE_KEY_CLOSED, "true");
//     }
//   };
