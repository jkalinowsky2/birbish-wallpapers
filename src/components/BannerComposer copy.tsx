...
const { pixelBase, illustratedBase, oddityBase } = config.assetBases ?? {};
...
export default function BannerComposer() {
    ...
    // --- helpers ---
    function urlForSlot(style: "none" | "illustrated" | "pixel" | "oddity", id?: string) {
        ...
        return null; // no base defined for this style/collection
    }
